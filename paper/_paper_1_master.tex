...
\begin{figure}[!ht]
  ...
  \resizebox{\textwidth}{!}{
    ...
    \begin{tikzpicture}[node distance=0cm, font=\sffamily]
      ...
      \draw [arrow] (ZOutcomerechts) -- node[Mk, xshift=0cm] {\textbf{Transformational mech.}:\\(1) Menu options (self-reinforcing)\\(2)Nonsystematic explanation (McCain personal reasons)} (Output1);
