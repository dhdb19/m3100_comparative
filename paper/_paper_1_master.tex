...
\begin{figure}%[H]
  ...
  \begin{tikzpicture}[node distance=0cm, font=\sffamily]
    ...
    \node (ZOutcomelinks) [startstop, below of=Input1, xshift=1cm, yshift=-4cm] {\textbf{\textrm{(II)}} Costs increase};

    \node (ZOutcomerechts) [startstop, below of=Output1, xshift=-1cm, yshift=-4cm] {\textbf{\textrm{(III)}} Something else};
  ...
  \end{tikzpicture}
  \caption*{see e.g. \textcite[][]{Hedström1998}}
\end{figure}
