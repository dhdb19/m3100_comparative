...
For state governments' costs, the authors state \enquote{state budgets, meanwhile, strained under the weight of growing Medicaid costs} \parencite[][p. 451]{Jacobs2014}. Both governments and the medical sector \enquote{were additionally were increasingly saddled with the burden of providing services to individuals lacks insurance while doctors' incomes were falling} \pnotecite[p- 452]{Jacobs2014}.
