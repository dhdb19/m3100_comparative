*********************************************************************
 ...
 file from the 2018 NHIS Public Use HOUSEHLD.DAT ASCII file
...
FILENAME ASCIIDAT 'C:\NHIS2018\HOUSEHLD.dat';
...
*PROC FORMAT;
   ...
   VALUE HHP008X
      ...
      02                 = 
"02 HU in permanent in transient/nontransient hotel, motel"
...
DATA NHIS.HOUSEHLD;
   ...
   * DEFINE LENGTH OF ALL VARIABLES;
   ...
   LENGTH
      ...
      INTV_MON   3   WTIA_HH    8   WTFA_HH    8
   ...
   * INPUT ALL VARIABLES;
   ...
   INPUT
      ...
      INTV_MON     14 -  15    WTIA_HH      16 -  21 .1
      WTFA_HH      22 -  27
   ...
   * DEFINE VARIABLE LABELS;
   ...
   LABEL
      ...
      LIVQRT_P   ="Type of Living Quarters"
   ...
   *    (PUT ASTERISK (*) BEFORE WORD "FORMAT"
   ...
   FORMAT
      ...
      INTV_QRT  HHP004X.   INTV_MON  HHP005X.   WTIA_HH   GROUPN.
      WTFA_HH   GROUPN.
...
PROC CONTENTS DATA=NHIS.HOUSEHLD;
   TITLE1 'CONTENTS OF THE 2018 NHIS Household FILE';

PROC FREQ DATA=NHIS.HOUSEHLD NOTITLE;
   TABLES RECTYPE/LIST MISSING;
   TITLE1 'FREQUENCY REPORT FOR 2018 NHIS Household FILE';
   TITLE2 '(WEIGHTED)';
   WEIGHT WTFA_HH;
