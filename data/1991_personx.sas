...
FILE FROM THE NHIS 1991 PERSONSX.DAT ASCII FILE.
...
FILENAME ASCIIDAT 'C:\NHIS1991\PERSONSX.DAT';
...
LENGTH
   ...
   OTHDAY    3  BDDAY12M  3  BDDAY12R  3  DV12      3  DVINT     3
   NCOND     3  NACUTE    3  NDV2      3  HEP12     3  HDA12     3
   HEP12X    3  HDA12X    3  DISDA6    3  DIS6X     3  DISDA6X   3
   DISDA12X  3  YRSLIVPR  3  YRSLIVUS  3  WTINT     8  SUBTYPE   3
...
INPUT
   ...
   BDDAY12M   108 - 110        BDDAY12R   111 - 111
...
LABEL
   ...
   BDDAY12M = "BED DAYS IN PAST 12 MONTHS"
   ...
   WT65     = "6 5 WEIGHT QUARTER, SEMI-ANNUAL, AND ANNUAL ESTIMATED RESTRICTED ACTIVITY DAYS IN PAST 2 WEEKS"
   RADAYWP  = "ESTIMATED RA DAYS PAST 2W - QUARTER, SEMI-ANNUAL AND ANNUAL"
   ...
   DV12WPQ  = "ESTIMATED DOCTOR VISITS DAYS PAST 12M - QUARTER"
   DV12WPS  = "ESTIMATED DOCTOR VISITS DAYS PAST 12M - SEMI-ANNUAL"
   DV12WPA  = "ESTIMATED DOCTOR VISITS DAYS PAST 12M - ANNUAL"
...
FORMAT
   ...
   AGER2     PER016X.    AGER3     PER017X.    BIRTHMO   $PER018X.
   BIRTHYR   $PER019X.   RACE      PER020X.    RACER1    PER021X.
   ...
   INCFAMR   PER034X.    POVERTY   PER035X.    FAMNUM    $PER036X.
   ...
   WKCLASS   PER049X.    INDUS     PER050X.    INDUSR1   PER051X.
   INDUSR2   PER052X.    OCCUP     PER053X.    OCCUPR1   PER054X.
   OCCUPR2   PER055X.    RESPOND   PER056X.    CONDLIST  PER057X.
   HEIGHT    PER058X.    WEIGHT    PER059X.    RADAY     PER060X.
   BDDAY     PER061X.    WLDAY     PER062X.    SLDAY     PER063X.
   OTHDAY    PER064X.    BDDAY12M  PER065X.    BDDAY12R  PER066X.
   DV12      PER067X.    DVINT     PER068X.    NCOND     PER069X.
   NACUTE    PER070X.    NDV2      PER071X.    HEP12     PER072X.
   HDA12     PER073X.    HEP12X    PER074X.    HDA12X    PER075X.
   DISDA6    PER076X.    DIS6X     PER077X.    DISDA6X   PER078X.
   DISDA12X  PER079X.    YRSLIVPR  PER080X.    YRSLIVUS  PER081X.
   WTINT     PER082X.    SUBTYPE   PER083X.    STRATUM   PER084X.
   REGION    PER085X.    MSASIZE   PER086X.    PSUTYPE   PER087X.
   MSA       PER088X.    PSUPSEUD  PER089X.    CCFACT    PER090X.
   WTFQ      PER091X.    WTFS      PER092X.    WTFA      PER093X.
   WT65      PER094X.    RADAYWP   PER095X.    BDDAYWP   PER096X.
   WLDAYWP   PER097X.    SLDAYWP   PER098X.    DV12WPQ   PER099X.
   DV12WPS   PER100X.    DV12WPA   PER101X.    HDA12WPQ  PER102X.
   HDA12WPS  PER103X.    HDA12WPA  PER104X.    HEP12WP   PER105X.
   ;
 
PROC CONTENTS DATA=NHIS.PERSONSX;
 
PROC FREQ DATA=NHIS.PERSONSX;
TITLE1 'FREQUENCY REPORT FOR 1991 NHIS PERSON FILE';
TITLE2 '(WEIGHTED)';
