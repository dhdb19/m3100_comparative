*********************************************************************
 OCTOBER 19, 2001  2:44 PM
 
 THIS IS AN EXAMPLE OF A SAS PROGRAM THAT CREATES A SAS
 FILE FROM THE 2000 NHIS PUBLIC USE HOUSEHLD.DAT ASCII FILE
...
* CREATE A SAS DATA SET STORED IN DIR 'C:\NHIS2000\';
   INFILE 'C:\NHIS2000\HOUSEHLD.DAT' MISSOVER TRUNCOVER LRECL=59;
...
PROC CONTENTS DATA=NHIS.HOUSEHLD;
   TITLE1 'CONTENTS OF THE 2000 NHIS HOUSEHLD FILE';

PROC FREQ DATA=NHIS.HOUSEHLD;
   TITLE1 'FREQUENCY REPORT FOR 2000 NHIS HOUSEHLD FILE';
   TITLE2 '(WEIGHTED)';
