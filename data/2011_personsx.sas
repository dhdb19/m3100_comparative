*********************************************************************
 ...
 file from the 2011 NHIS Public Use PERSONSX.DAT ASCII file
...
FILENAME ASCIIDAT 'C:\NHIS2011\PERSONSX.dat';
...
DATA NHIS.PERSONSX;
   ...
   * DEFINE LENGTH OF ALL VARIABLES;
   ...
   LENGTH
      ...
      ARMFT10P   3   ARMFDS     3   DOINGLWP   3   WHYNOWKP   3
...
"Received Social Security or Railroad Retirement income as a disability benefit"
      ...
      PPENS      ="Received income from other disability pensions"
...
"Received income from a state or county welfare program (e.g., TANF)"
   ...
   *    (PUT ASTERISK (*) BEFORE WORD "FORMAT"
   ...
   FORMAT
      ...
      PLNPAY61  PEP072X.   PLNPAY71  PEP072X.   HICOSTR1  PEP440X.
      EMPPAY1   PEP441X.   ECOSTR1   PEP442X.   EMPCSTP1  PEP443X.
      PLNMGD1   PEP444X.   HDHP1     PEP445X.   HSAHRA1   PEP037X.
      MGCHMD1   PEP447X.   MGPRMD1   PEP037X.   MGPYMD1   PEP037X.
      MGPREF1   PEP037X.   PCPREQ1   PEP037X.   PRRXCOV1  PEP037X.
      PRDNCOV1  PEP037X.   WHONAM2   PEP420X.   PRPOLH2   PEP421X.
      PRCOOH2   PEP037X.   PRCTOH2   PEP387X.   PRRLOH12  PEP072X.
      PRRLOH22  PEP072X.   PRRLOH32  PEP072X.   PRRLOH42  PEP072X.
      PRCNUM2   PEP428X.   COHU192   PEP387X.   COH19252  PEP387X.
      COHO252   PEP387X.   PLNWRKR2  PEP432X.   PLNPAY12  PEP072X.
      PLNPAY22  PEP072X.   PLNPAY32  PEP072X.   PLNPAY42  PEP072X.
      PLNPAY52  PEP072X.   PLNPAY62  PEP072X.   PLNPAY72  PEP072X.
      HICOSTR2  PEP440X.   EMPPAY2   PEP441X.   ECOSTR2   PEP442X.
      EMPCSTP2  PEP443X.   PLNMGD2   PEP444X.   HDHP2     PEP445X.
      HSAHRA2   PEP037X.   MGCHMD2   PEP447X.   MGPRMD2   PEP037X.
      MGPYMD2   PEP037X.   MGPREF2   PEP037X.   PCPREQ2   PEP037X.
      PRRXCOV2  PEP037X.   PRDNCOV2  PEP037X.   PRPLPLUS  PEP037X.
      FCOVCONF  PEP489X.   SCHIP     PEP394X.   STDOC1    PEP403X.
      STPCMD1   PEP037X.   STREF1    PEP037X.   OTHPUB    PEP394X.
      STDOC2    PEP403X.   STPCMD2   PEP037X.   STREF2    PEP037X.
      OTHGOV    PEP394X.   STDOC3    PEP403X.   STPCMD3   PEP037X.
      STREF3    PEP037X.   MILCARE   PEP394X.   MILSPC1   PEP072X.
      MILSPC2   PEP072X.   MILSPC3   PEP072X.   MILSPC4   PEP072X.
      MILMAN    PEP507X.   IHS       PEP037X.   HILAST    PEP509X.
      ...
      FHIKDBJ   PEP072X.   FHIKDBK   PEP072X.   PWRKBR1   PEP432X.
      HCSPFYR   PEP540X.   MEDBILL   PEP037X.   MEDBPAY   PEP037X.
      ...
      PLBORN    PEP037X.   REGIONBR  PEP560X.   GEOBRTH   PEP561X.
      YRSINUS   PEP562X.   CITIZENP  PEP563X.   HEADST    PEP037X.
      HEADSTV1  PEP037X.   EDUC1     PEP566X.   ARMFVER   PEP037X.
      ARMFEV    PEP037X.   ARMFFC    PEP037X.   ARMFTM1   PEP072X.
      ARMFTM2   PEP072X.   ARMFTM3   PEP072X.   ARMFTM4   PEP072X.
      ARMFTM5   PEP072X.   ARMFTM6   PEP072X.   ARMFTM7   PEP072X.
      ARMFTM8   PEP072X.   ARMFTM9   PEP072X.   ARMFT10P  PEP072X.
      ARMFDS    PEP037X.   DOINGLWP  PEP581X.   WHYNOWKP  PEP582X.
      WRKHRS2   PEP583X.   WRKFTALL  PEP037X.   WRKLYR1   PEP037X.
      WRKMYR    PEP586X.   ERNYR_P   PEP587X.   ERNYRFLG  PEP588X.
      HIEMPOF   PEP037X.

      /* FIN FORMAT ASSOCIATIONS */

      FINCINT   PEP590X.   PSAL      PEP037X.   PSEINC    PEP037X.
      ...
      TANFMYR   PEP387X.   ELIGPWIC  PEP609X.   PWIC      PEP037X.
      WIC_FLAG  PEP611X.;
RUN;

PROC CONTENTS DATA=NHIS.PERSONSX;
   TITLE1 'CONTENTS OF THE 2011 NHIS Person FILE';

PROC FREQ DATA=NHIS.PERSONSX NOTITLE;
   TABLES RECTYPE/LIST MISSING;
   TITLE1 'FREQUENCY REPORT FOR 2011 NHIS Person FILE';
   TITLE2 '(WEIGHTED)';
   WEIGHT WTFA;
