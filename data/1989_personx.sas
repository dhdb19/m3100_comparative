...
FILE FROM THE NHIS 1989 PERSONSX.DAT ASCII FILE.
...
FILENAME ASCIIDAT 'C:\NHIS1989\PERSONSX.DAT';
...
LENGTH
   ...
   INCFAM    3  INCFAMR   3  POVERTY   3  FAMRELR   3  FAMSIZER  3
   PARENT    3  MAJACT    3  HEALTH    3  LATOTAL   3  LAWORK    3
   LASCHOOL  3  LACARE    3  EMPLOY    3  WKCLASS   3  INDUS     3
   INDUSR1   3  INDUSR2   3  OCCUP     3  OCCUPR1   3  OCCUPR2   3
   RESPOND   3  CONDLIST  3  HEIGHT    3  WEIGHT    3  RADAY     3
   BDDAY     3  WLDAY     3  SLDAY     3  OTHDAY    3  BDDAY12   3
   BDDAY12R  3  DV12      3  DVINT     3  NCOND     3  NACUTE    3
   NDV2      3  HEP12     3  HDA12     3  HEP12X    3  HDA12X    3
   DISDA6    3  DIS6X     3  DISDA6X   3  DISDA12X  3  YRPRERES  3
   YRSINUS   3  WTINT     8  SUBTYPE   3  STRATUM   3  REGION    3
   MSASIZE   3  PSUTYPE   3  MSA       3  PSUSEUD   3  CCFACT    8
...
FORMAT
   ...
   FAMRELR   PER037X.    FAMSIZER  PER038X.    PARENT    PER039X.
   MAJACT    PER040X.    HEALTH    PER041X.    LATOTAL   PER042X.
   LAWORK    PER043X.    LASCHOOL  PER044X.    LACARE    PER045X.
   EMPLOY    PER046X.    WKCLASS   PER047X.    INDUS     PER048X.
   INDUSR1   PER049X.    INDUSR2   PER050X.    OCCUP     PER051X.
   ...
   DISDA6X   PER076X.    DISDA12X  PER077X.    YRPRERES  PER078X.
   YRSINUS   PER079X.    WTINT     PER080X.    SUBTYPE   PER081X.
   STRATUM   PER082X.    REGION    PER083X.    MSASIZE   PER084X.
   PSUTYPE   PER085X.    MSA       PER086X.    PSUSEUD   PER087X.
   CCFACT    PER088X.    WTFQ      PER089X.    WTFS      PER090X.
   WTFA      PER091X.    WT65      PER092X.    RADAYWP   PER093X.
   BDDAYWP   PER094X.    WLDAYWP   PER095X.    SLDAYWP   PER096X.
   DV12WPQ   PER097X.    DV12WPS   PER098X.    DV12WPA   PER099X.
   HDA12WPQ  PER100X.    HDA12WPS  PER101X.    HDA12WPA  PER102X.
   HEP12WP   PER103X.
   ;
...
TITLE1 'FREQUENCY REPORT FOR 1989 NHIS PERSON PUBLIC USE FILE';
TITLE2 '(WEIGHTED)';
