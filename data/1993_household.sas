...
FILE FROM THE NHIS 1993 HOUSEHLD.DAT ASCII FILE.
...
FILENAME ASCIIDAT 'C:\NHIS1993\HOUSEHLD.DAT';
...
INPUT
   ...
   IDATE    $  30 - 33         IVIEWMON $  30 - 31
   IVIEWDAY $  32 - 33         NFAM        34 - 35
...
LABEL
   ...
   IDATE    = "DATE OF COMPLETION (OR LAST ATTEMPT) OF INITIAL INTERVIEW"
   IVIEWMON = "MONTH"
   IVIEWDAY = "DAY"
   NFAM     = "NUMBER OF FAMILIES IN THE HOUSEHOLD"
   SIZEPRIM = "SIZE OF FAMILY - PRIMARY FAMILY"
   SIZESEC1 = "SIZE OF FAMILY  1"
   SIZESEC2 = "SIZE OF FAMILY  2"
   SIZESEC3 = "SIZE OF FAMILY  3"
   SIZESEC4 = "SIZE OF FAMILY  4"
   SIZESEC5 = "SIZE OF FAMILY  5"
   SIZESEC6 = "SIZE OF FAMILY  6"
   SIZESEC7 = "SIZE OF FAMILY  7"
   SIZESEC8 = "SIZE OF FAMILY  8"
   SIZESEC9 = "SIZE OF FAMILY  9"
   NUNREL   = "NUMBER OF UNRELATED INDIVIDUALS"
   REFPRESP = "REFERENCE PERSON PRESENT - PRIMARY FAMILY"
   REFPRES1 = "REFERENCE PERSON PRESENT"
   REFPRES2 = "REFERENCE PERSON PRESENT"
   REFPRES3 = "REFERENCE PERSON PRESENT"
   REFPRES4 = "REFERENCE PERSON PRESENT"
   REFPRES5 = "REFERENCE PERSON PRESENT"
   REFPRES6 = "REFERENCE PERSON PRESENT"
   REFPRES7 = "REFERENCE PERSON PRESENT"
   REFPRES8 = "REFERENCE PERSON PRESENT"
   REFPRES9 = "REFERENCE PERSON PRESENT"
   NPERSREC = "NUMBER PERSON RECORDS FOR THE HOUSEHOLD"
...
FORMAT
   ...
   COMIVIEW  HHD013X.    NONIVIEW  HHD014X.    IDATE     $HHD015X.
   IVIEWMON  $HHD016X.   IVIEWDAY  $HHD017X.   NFAM      HHD018X.
   ...
   SIZESEC9  HHD028X.    NUNREL    HHD029X.    REFPRESP  HHD030X.
   ...
   NHOSPREC  HHD043X.    CONDLIST  HHD044X.    SUBTYPE   HHD045X.
   REGION    HHD046X.    MSASIZE   HHD047X.    PSUTYPE   HHD048X.
   MSA       HHD049X.    WTFQ      HHD050X.
   ;
 
PROC CONTENTS DATA=NHIS.HOUSEHLD;

PROC FREQ DATA=NHIS.HOUSEHLD;
TITLE1 'FREQUENCY REPORT FOR 1993 NHIS HOUSEHOLD FILE';
TITLE2 '(WEIGHTED)';
