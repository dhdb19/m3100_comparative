...
FILE FROM THE NHIS 1994 PERSONSX.DAT ASCII FILE.
...
FILENAME ASCIIDAT 'C:\NHIS1994\PERSONSX.DAT';
...
LENGTH
   ...
   DISDA6X   3  DISDA12X  3  YRSLIVPR  3  YRSLIVUS  3  WTINT     8
   ...
   HDA12WPS  6  HDA12WPA  6  HEP12WP   6
   ;
...
LABEL
   ...
   PARENT   = "PARENT/OTHER ADULT RELATIVE (UNDER 25)"
   ...
   LACARE   = "NEEDS HELP WITH PERSONAL CARE (5-59 YEARS"
   ...
   CCFACT   = "CHRONIC CONDITION PREVALENCE AND INCIDENCE"
   WTFQ     = "QUARTER"
   WTFS     = "SEMI-ANNUAL (WT/2)"
   WTFA     = "ANNUAL (WT/4)"
   WT65     = "QUARTER, SEMI-ANNUAL, AND ANNUAL ESTIMATED RESTRICTED ACTIVITY DAYS IN PAST 2 WEEKS"
   RADAYWP  = "QUARTER, SEMI-ANNUAL AND ANNUAL ESTIMATED BED DAYS IN PAST 2 WEEKS"
   BDDAYWP  = "QUARTER, SEMI-ANNUAL AND ANNUAL ESTIMATED WORK-LOSS DAYS IN PAST 2 WEEKS"
   WLDAYWP  = "QUARTER, SEMI-ANNUAL AND ANNUAL ESTIMATED SCHOOL-LOSS DAYS IN PAST 2 WEEKS"
   SLDAYWP  = "QUARTER, SEMI-ANNUAL AND ANNUAL ESTIMATED DOCTOR VISITS IN PAST 12 MONTHS"
   DV12WPQ  = "QUARTER"
   DV12WPS  = "SEMI-ANNUAL"
   DV12WPA  = "ANNUAL ESTIMATED SHORT-STAY HOSPITAL EPISODE DAYS IN PAST 12 MONTHS"
   HDA12WPQ = "QUARTER"
   HDA12WPS = "SEMI-ANNUAL"
   HDA12WPA = "ANNUAL"
...
FORMAT
   ...
   YRSLIVPR  PER082X.    YRSLIVUS  PER083X.    WTINT     PER084X.
   SUBTYPE   PER085X.    STRATUM   PER086X.    REGION    PER087X.
   MSASIZE   PER088X.    PSUTYPE   PER089X.    MSA       PER090X.
   PSUPSEUD  PER091X.    CCFACT    PER092X.    WTFQ      PER093X.
   WTFS      PER094X.    WTFA      PER095X.    WT65      PER096X.
   RADAYWP   PER097X.    BDDAYWP   PER098X.    WLDAYWP   PER099X.
   SLDAYWP   PER100X.    DV12WPQ   PER101X.    DV12WPS   PER102X.
   DV12WPA   PER103X.    HDA12WPQ  PER104X.    HDA12WPS  PER105X.
   HDA12WPA  PER106X.    HEP12WP   PER107X.
   ;
 
PROC CONTENTS DATA=NHIS.PERSONSX;
 
PROC FREQ DATA=NHIS.PERSONSX;
TITLE1 'FREQUENCY REPORT FOR 1994 NHIS PERSON FILE';
TITLE2 '(WEIGHTED)';
