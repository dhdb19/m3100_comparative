...
FILE FROM THE NHIS 1975 HOUSEHLD.DAT ASCII FILE.
...
LIBNAME NHIS    'C:\NHIS1975\';
LIBNAME LIBRARY 'C:\NHIS1975\';
 
FILENAME ASCIIDAT 'C:\NHIS1975\HOUSEHLD.DAT';
...
DATA NHIS.HOUSEHLD;
* CREATE A SAS DATA SET STORED IN DIR 'C:\NHIS1975\';
...
LENGTH
   ...
   WEEKPROC  3  HH_28     3  HH_29     3  HH_30     3  HH_33     3
   HH_36     3  HH_37     3  HH_40     3  HH_42     3  HH_43     3
   HH_44     3  HH_45     3  HH_46     3  HH_49     3  HH_50     3
   HH_51     3  HH_52     3  HH_56     3  HH_58     3  HH_60     3
   HH_62     3  HH_64     3  HH_66     3  HH_68     3  HH_70     3
   HH_72     3  HH_74     3  HH_76     3  HH_78     3  HH_80     3
   HH_82     3  HH_84     3  HH_86     3  HH_87     3  HH_88     3
   HH_89     3  HH_90     3  HH_91     3  HH_92     3  HH_93     3
   HH_94     3  HH_95     3  WTFQ      8
   ;
* INPUT ALL VARIABLES;
...
LABEL
   ...
   QUARTER  = "DATA COLLECTION QUARTER CODE"
...
FORMAT
   ...
   QUARTER   HHD007X.    YEAR      HHD008X.    WEEKPROC  HHD009X.
   HH_28     HHD010X.    HH_29     HHD011X.    HH_30     HHD012X.
   HH_33     HHD013X.    HH_36     HHD014X.    HH_37     HHD015X.
   HH_40     HHD016X.    HH_42     HHD017X.    HH_43     HHD018X.
   HH_44     HHD019X.    HH_45     HHD020X.    HH_46     HHD021X.
   HH_49     HHD022X.    HH_50     HHD023X.    HH_51     HHD024X.
   HH_52     HHD025X.    HH_56     HHD026X.    HH_58     HHD027X.
   HH_60     HHD028X.    HH_62     HHD029X.    HH_64     HHD030X.
   HH_66     HHD031X.    HH_68     HHD032X.    HH_70     HHD033X.
   HH_72     HHD034X.    HH_74     HHD035X.    HH_76     HHD036X.
   HH_78     HHD037X.    HH_80     HHD038X.    HH_82     HHD039X.
   HH_84     HHD040X.    HH_86     HHD041X.    HH_87     HHD042X.
   HH_88     HHD043X.    HH_89     HHD044X.    HH_90     HHD045X.
   HH_91     HHD046X.    HH_92     HHD047X.    HH_93     HHD048X.
   HH_94     HHD049X.    HH_95     HHD050X.    HH_96     $HHD051X.
   HH_98     $HHD052X.   HH_180    $HHD053X.   HH_181    $HHD054X.
   WTFQ      HHD055X.
   ;
...
TITLE1 'FREQUENCY REPORT FOR 1975 NHIS HOUSEHOLD FILE';
TITLE2 '(WEIGHTED)';
