...
FILE FROM THE NHIS 1981 PERSONSX.DAT ASCII FILE.
...
FILENAME ASCIIDAT 'C:\NHIS1981\PERSONSX.DAT';
...
PROC FORMAT LIBRARY=LIBRARY;
  ...
  VALUE  PER046X
   ...
   4                = "Not limited (including unknown) or not applic\-able (persons with no chronic condition )"
   ;
  VALUE  PER047X
   1                = "Months"
   2                = "Years"
...
INPUT
   ...
   PER179     179 - 179        PER182     182 - 187
   PER188     188 - 192        PER193     193 - 198
   PER199     199 - 200        PER201     201 - 209
...
LABEL
   ...
   PER142   = "BED DAYS PAST 12 MONTHS"
...
FORMAT
   ...
   PER177    PER076X.    PER179    PER077X.    PER182    PER078X.
   PER188    PER079X.    PER193    PER080X.    PER199    PER081X.
   PER201    PER082X.    PER210    PER083X.    WTFA      PER084X.
   PER228    PER085X.    PER237    PER086X.    PER246    PER087X.
   PER255    PER088X.    PER264    PER089X.    PER273    PER090X.
   PER282    PER091X.    PER291    PER092X.    PER300    PER093X.
   PER327    PER094X.    PER336    PER095X.    PER345    PER096X.
...
TITLE1 'FREQUENCY REPORT FOR 1981 NHIS PERSON FILE';
TITLE2 '(WEIGHTED)';
