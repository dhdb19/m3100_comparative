*********************************************************************
 ...
 file from the 2008 NHIS Public Use PERSONSX.DAT ASCII file
...
FILENAME ASCIIDAT 'C:\NHIS2008\PERSONSX.dat';
...
;
   ...
   * DEFINE VARIABLE LABELS;
   ...
   LABEL
      ...
      QCADULT    ="Sample Adult data removed for quality reasons"
      QCCHILD    ="Sample Child data removed for quality reasons"
...
"Health Savings Accounts/Health Reimbursement Accounts (plan 2)"
   ...
   *    (PUT ASTERISK (*) BEFORE WORD "FORMAT"
   ...
   FORMAT
      ...
      PRRXCOV1  PEP037X.   PRDNCOV1  PEP037X.   HITYPEN2  PEP439X.
      ...
      STREF2    PEP037X.   OTHGOV    PEP393X.   STDOC3    PEP402X.
...
PROC CONTENTS DATA=NHIS.PERSONSX;
   TITLE1 'CONTENTS OF THE 2008 NHIS Person FILE';

PROC FREQ DATA=NHIS.PERSONSX NOTITLE;
   TABLES RECTYPE/LIST MISSING;
   TITLE1 'FREQUENCY REPORT FOR 2008 NHIS Person FILE';
   TITLE2 '(WEIGHTED)';
   WEIGHT WTFA;
