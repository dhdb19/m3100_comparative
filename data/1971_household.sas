...
FILE FROM THE NHIS 1971 HOUSEHLD.DAT ASCII FILE.
...
FILENAME ASCIIDAT 'C:\NHIS1971\HOUSEHLD.DAT';
...
PROC FORMAT LIBRARY=LIBRARY;
  ...
  VALUE  HHD014X
   ...
   ;
  VALUE  HHD015X
   1                = "In SMA, in Central City of SMA"
   2                = "In SMA, not in Central City of SMA"
   3                = "Not in SMA"
   ;
  VALUE  HHD016X
   1                = "SMSA"
...
LENGTH
   HH_1      3  HH_2      3  WEEKCEN   3  RECTYPE   3  HH_17     3
   QUARTER   3  YEAR      3  WEEKPROC  3  HH_28     3  HH_29     3
   HH_30     3  HH_33     3  HH_36     3  HH_37     3 
   HH_42     3  HH_43     3  HH_44     3  HH_45     3  HH_46     3
   HH_49     3  HH_50     3  HH_51     3  HH_52     3  HH_56     3
   HH_58     3  HH_60     3  HH_62     3  HH_64     3  HH_66     3
   HH_68     3  HH_70     3  HH_72     3  HH_74     3  HH_76     3
   HH_78     3  HH_80     3  HH_82     3  HH_84     3  HH_86     3
   HH_87     3  HH_88     3  HH_89     3  HH_90     3  HH_91     3
   HH_92     3  HH_93     3  HH_94     3  HH_95     3  WTFQ      8
   ;
* INPUT ALL VARIABLES;
...
INPUT
   ...
   WEEKPROC    21 - 22         HH_28       28 - 28
   HH_29       29 - 29         HH_30       30 - 31
   HH_33       33 - 33         HH_36       36 - 36
   HH_37       37 - 37         HH_38     $ 38 - 41
   HH_42       42 - 42         HH_43       43 - 43
   HH_44       44 - 44         HH_45       45 - 45
   HH_46       46 - 48         HH_49       49 - 49
   HH_50       50 - 50         HH_51       51 - 51
   HH_52       52 - 53         HH_56       56 - 57
   HH_58       58 - 59         HH_60       60 - 61
   HH_62       62 - 63         HH_64       64 - 65
...
LABEL
   ...
   HH_52    = "SPECIAL DWELLING PLACE"
   HH_56    = "NUMBER OF UNRELATED INDIVIDUALS"
   HH_58    = "NUMBER OF PERSONS IN THE HOUSEHOLD"
   HH_60    = "NUMBER OF CONDITIONS IN THE HOUSEHOLD"
   HH_62    = "NUMBER OF HOSPITAL EPISODES"
   HH_64    = "NUMBER OF DOCTOR VISITS"
...
FORMAT
   HH_1      HHD001X.    HH_2      HHD002X.    PSUNUMR   $HHD003X.
   WEEKCEN   HHD004X.    SEGNUM    $HHD005X.   HHNUM     $HHD006X.
   RECTYPE   HHD007X.    HH_17     HHD008X.    QUARTER   HHD009X.
   YEAR      HHD010X.    WEEKPROC  HHD011X.    HH_28     HHD012X.
   HH_29     HHD013X.    HH_30     HHD014X.    HH_33     HHD015X.
   HH_36     HHD016X.    HH_37     HHD017X.    HH_38     $HHD018X.
   HH_42     HHD019X.    HH_43     HHD020X.    HH_44     HHD021X.
   HH_45     HHD022X.    HH_46     HHD023X.    HH_49     HHD024X.
   HH_50     HHD025X.    HH_51     HHD026X.    HH_52     HHD027X.
   HH_56     HHD028X.    HH_58     HHD029X.    HH_60     HHD030X.
   HH_62     HHD031X.    HH_64     HHD032X.    HH_66     HHD033X.
   HH_68     HHD034X.    HH_70     HHD035X.    HH_72     HHD036X.
   HH_74     HHD037X.    HH_76     HHD038X.    HH_78     HHD039X.
   HH_80     HHD040X.    HH_82     HHD041X.    HH_84     HHD042X.
   HH_86     HHD043X.    HH_87     HHD044X.    HH_88     HHD045X.
   HH_89     HHD046X.    HH_90     HHD047X.    HH_91     HHD048X.
   HH_92     HHD049X.    HH_93     HHD050X.    HH_94     HHD051X.
   HH_95     HHD052X.    HH_96     $HHD053X.   HH_98     $HHD054X.
   WTFQ      HHD055X.
   ;
...
TITLE1 'FREQUENCY REPORT FOR 1971 NHIS HOUSEHOLD FILE';
TITLE2 '(WEIGHTED)';
