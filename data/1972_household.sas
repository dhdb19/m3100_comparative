...
FILE FROM THE NHIS 1972 HOUSEHLD.DAT ASCII FILE.
...
FILENAME ASCIIDAT 'C:\NHIS1972\HOUSEHLD.DAT';
...
LENGTH
   ...
   HH_30     3  HH_33     3  HH_36     3  HH_37     3  HH_40     3
   ...
   HH_92     3  HH_93     3  HH_94     3  HH_95     3  HH_114    3
   WTFQ      8
   ;
* INPUT ALL VARIABLES;
...
LABEL
   ...
   HH_114   = "NUMBER OF 12 MONTH DOCTOR VISITS IN THE HOUSEHOLD"
   WTFQ     = "BASIC WEIGHT"
   ;
...
FORMAT
   ...
   HH_36     HHD016X.    HH_37     HHD017X.    HH_40     HHD018X.
   ...
   HH_114    HHD055X.    WTFQ      HHD056X.
   ;
 
PROC CONTENTS DATA=NHIS.HOUSEHLD;
 
PROC FREQ DATA=NHIS.HOUSEHLD;
TITLE1 'FREQUENCY REPORT FOR 1972 NHIS HOUSEHOLD FILE';
TITLE2 '(WEIGHTED)';
