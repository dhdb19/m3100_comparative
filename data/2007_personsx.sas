*********************************************************************
 ...
 file from the 2007 NHIS Public Use PERSONSX.DAT ASCII file
...
FILENAME ASCIIDAT 'C:\NHIS2007\PERSONSX.dat';
...
DATA NHIS.PERSONSX;
   ...
   * DEFINE LENGTH OF ALL VARIABLES;
   ...
   LENGTH
      ...
      MGPREF1    3   PRRXCOV1   3   HITYPE2    3   WHONAM2    3
      PLNWRKN2   3   PLNPAY12   3   PLNPAY22   3   PLNPAY32   3
      PLNPAY42   3   PLNPAY52   3   PLNPAY62   3   PLNPAY72   3
      HICOSTR2   4   PLNMGD2    3   HDHP2      3   HSAHRA2    3
      ...
      FSA        3   HIKINDA    3   HIKINDB    3   HIKINDC    3
...
"Receive Special Education/EIS due to emotional/behavioral problem"
      ...
      PLAWALK    ="Does - - have difficulty walk w/o equipment?"
...
"Duration of depression/anxiety/emotional problem: Number of units"
      ...
      LADURB26   ="Duration of skin problems recode 2"
...
"Health Savings Accounts/Health Reimbursement Accounts (Plan 2)"
   ...
   *    (PUT ASTERISK (*) BEFORE WORD "FORMAT"
   ...
   FORMAT
      ...
      HDHP1     PEP429X.   HSAHRA1   PEP037X.   MGCHMD1   PEP431X.
      MGPRMD1   PEP037X.   MGPYMD1   PEP037X.   MGPREF1   PEP037X.
      PRRXCOV1  PEP037X.   HITYPE2   PEP384X.   WHONAM2   PEP418X.
      PLNWRKN2  PEP419X.   PLNPAY12  PEP069X.   PLNPAY22  PEP069X.
      PLNPAY32  PEP069X.   PLNPAY42  PEP069X.   PLNPAY52  PEP069X.
      PLNPAY62  PEP069X.   PLNPAY72  PEP069X.   HICOSTR2  PEP427X.
      PLNMGD2   PEP428X.   HDHP2     PEP429X.   HSAHRA2   PEP037X.
      MGCHMD2   PEP431X.   MGPRMD2   PEP037X.   MGPYMD2   PEP037X.
      MGPREF2   PEP037X.   PRRXCOV2  PEP037X.   PRPLPLUS  PEP037X.
      SCHIP     PEP391X.   STDOC1    PEP400X.   STPCMD1   PEP037X.
      STREF1    PEP037X.   OTHERPUB  PEP391X.   STDOC2    PEP400X.
      STPCMD2   PEP037X.   STREF2    PEP037X.   OTHERGOV  PEP391X.
      STDOC3    PEP400X.   STPCMD3   PEP037X.   STREF3    PEP037X.
      MILITARY  PEP391X.   MILSPC1   PEP069X.   MILSPC2   PEP069X.
      MILSPC3   PEP069X.   MILSPC4   PEP069X.   MILMAN    PEP473X.
      IHS       PEP037X.   HILAST    PEP475X.   HISTOP1   PEP069X.
      HISTOP2   PEP069X.   HISTOP3   PEP069X.   HISTOP4   PEP069X.
      HISTOP5   PEP069X.   HISTOP6   PEP069X.   HISTOP7   PEP069X.
      HISTOP8   PEP069X.   HISTOP9   PEP069X.   HISTOP10  PEP069X.
      HISTOP11  PEP069X.   HISTOP12  PEP069X.   HISTOP13  PEP069X.
      HISTOP14  PEP069X.   HISTOP15  PEP069X.   HINOTYR   PEP037X.
      HINOTMYR  PEP384X.   HCSPFYR   PEP493X.   FSA       PEP037X.
      HIKINDA   PEP069X.   HIKINDB   PEP069X.   HIKINDC   PEP069X.
      HIKINDD   PEP069X.   HIKINDE   PEP069X.   HIKINDF   PEP069X.
      HIKINDG   PEP069X.   HIKINDH   PEP069X.   HIKINDI   PEP069X.
      HIKINDJ   PEP069X.   HIKINDK   PEP069X.   MCAREPRB  PEP037X.
      MCAIDPRB  PEP037X.   SINCOV    PEP037X.

      /* FSD FORMAT ASSOCIATIONS */

      PLBORN    PEP037X.   REGIONBR  PEP510X.   GEOBRTH   PEP511X.
      YRSINUS   PEP512X.   CITIZENP  PEP513X.   HEADST    PEP037X.
      HEADSTV1  PEP037X.   EDUC1     PEP516X.   PMILTRY   PEP037X.
      DOINGLWP  PEP518X.   WHYNOWKP  PEP519X.   WRKHRS2   PEP520X.
      WRKFTALL  PEP037X.   WRKLYR1   PEP037X.   WRKMYR    PEP523X.
      ERNYR_P   PEP524X.   HIEMPOF   PEP037X.

      /* FIN FORMAT ASSOCIATIONS */

      FINCINT   PEP526X.   PSAL      PEP037X.   PSEINC    PEP037X.
      ...
      TANFMYR   PEP384X.   PFSTP     PEP037X.   FSTPMYR   PEP384X.
      ELIGPWIC  PEP547X.   PWIC      PEP037X.   WIC_FLAG  PEP549X.;
RUN;

PROC CONTENTS DATA=NHIS.PERSONSX;
   TITLE1 'CONTENTS OF THE 2007 NHIS Person FILE';

PROC FREQ DATA=NHIS.PERSONSX NOTITLE;
   TABLES RECTYPE/LIST MISSING;
   TITLE1 'FREQUENCY REPORT FOR 2007 NHIS Person FILE';
   TITLE2 '(WEIGHTED)';
   WEIGHT WTFA;
