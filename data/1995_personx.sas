...
FILE FROM THE NHIS 1995 PERSONSX.DAT ASCII FILE.
...
FILENAME ASCIIDAT 'C:\NHIS1995\PERSONSX.DAT';
...
PROC FORMAT LIBRARY=LIBRARY;
  ...
  VALUE $PER035X
   ...
   "0"              = "Reference person, 2 or more persons in household"
  ...
  VALUE  PER039X
   ...
   6                = "Father and other 21+ years old adult relative"
   7                = "No parent, but one 21+ years old adult relative"
  ...
  VALUE  PER044X
   ...
   .                = "Not applicable (Under 5 years or 18 or more years)"
   ;
  VALUE  PER045X
...
LENGTH
   ...
   DIS6X     3  DISDA6X   3  DISDA12X  3  YRSLIVPR  3  YRSLIVUS  3
...
LABEL
   ...
   HEP12    = "NUMBER OF SHORT-STAY HOSPITAL EPISODES"
   HDA12    = "SHORT-STAY HOSPITAL EPISODE DAYS IN"
   HEP12X   = "NUMBER OF SHORT-STAY HOSPITAL EPISODES"
   HDA12X   = "SHORT-STAY HOSPITAL EPISODE DAYS IN"
   ...
   WLDAYWP  = "WORK-LOSS DAYS IN PAST 2 WEEKS - QUARTER, SEMI-ANNUAL AND ANNUAL"
   ...
   HEP12WP  = "ANNUAL ESIMATED NUMBER OF SHORT-STAY HOSPITAL EPIDSODES IN PAST 12 MONTHS"
...
FORMAT
   ...
   AGE       PER010X.    AGER1     PER011X.    AGER2     PER012X.
   AGER3     PER013X.    BIRTH     $PER014X.   BIRTHMO   $PER015X.
   BIRTHYR   $PER016X.   HISPFLAG  PER017X.    RACE      PER018X.
   RACER1    PER019X.    RACER2    PER020X.    RACER3    PER021X.
   HISPANIC  PER022X.    MARSTAT   PER023X.    VETERAN   PER024X.
   RESERVE   PER025X.    EDUC      PER026X.    EDUCR     PER027X.
   EDUCAD    PER028X.    EDUCADR   PER029X.    INCFAM20  PER030X.
   INCFAM    PER031X.    INCFAMR   PER032X.    POVERTY   PER033X.
   FAMTYPE   $PER034X.   FAMREL    $PER035X.   FAMRELR   PER036X.
   FAMSIZE   PER037X.    FAMSIZER  PER038X.    PARENT    PER039X.
   MAJACT    PER040X.    HEALTH    PER041X.    LATOTAL   PER042X.
   LAWORK    PER043X.    LASCHOOL  PER044X.    LACARE    PER045X.
   EMPLOY    PER046X.    WKCLASS   PER047X.    INDUSR1   PER048X.
   INDUSR2   PER049X.    OCCUPR1   PER050X.    OCCUPR2   PER051X.
   RESPOND   PER052X.    CONDLIST  PER053X.    HEIGHT    PER054X.
   WEIGHT    PER055X.    RADAY     PER056X.    BDDAY     PER057X.
   WLDAY     PER058X.    SLDAY     PER059X.    OTHDAY    PER060X.
   BDDAY12   PER061X.    BDDAY12R  PER062X.    DV12      PER063X.
   DVINT     PER064X.    NCOND     PER065X.    NACUTE    PER066X.
   NDV2      PER067X.    HEP12     PER068X.    HDA12     PER069X.
   HEP12X    PER070X.    HDA12X    PER071X.    DISDA6    PER072X.
   DIS6X     PER073X.    DISDA6X   PER074X.    DISDA12X  PER075X.
   YRSLIVPR  PER076X.    YRSLIVUS  PER077X.    WTINT     PER078X.
   QUARTER   PER079X.    REGION    PER080X.    MSASIZE   PER081X.
   MSA       PER082X.    CCFACT    PER083X.    WTFQ      PER084X.
   WTFS      PER085X.    WTFA      PER086X.    WT65      PER087X.
   RADAYWP   PER088X.    BDDAYWP   PER089X.    WLDAYWP   PER090X.
   SLDAYWP   PER091X.    DV12WPQ   PER092X.    DV12WPS   PER093X.
   DV12WPA   PER094X.    HDA12WPQ  PER095X.    HDA12WPS  PER096X.
   HDA12WPA  PER097X.    HEP12WP   PER098X.    VARSTRAR  PER099X.
   VARPSUR   PER100X.    VARSUBSR  PER101X.    UNITSS    PER102X.
   TYPEPSU   PER103X.    PANEL     PER104X.
   ;
 
PROC CONTENTS DATA=NHIS.PERSONSX;
 
PROC FREQ DATA=NHIS.PERSONSX;
TITLE1 'FREQUENCY REPORT FOR 1995 NHIS PERSON FILE';
TITLE2 '(WEIGHTED)';
