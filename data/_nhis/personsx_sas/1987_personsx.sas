...
FILE FROM THE NHIS 1987 PERSONSX.DAT ASCII FILE.
...
FILENAME ASCIIDAT 'C:\NHIS1987\PERSONSX.DAT';
...
PROC FORMAT LIBRARY=LIBRARY;
  ...
  VALUE  PER083X
   ...
   ;
  VALUE  PER084X
   1                = "True Hispanic oversample, 18+"
   2                = "Not true oversample, but Hispanic, 18+"
   3                = "Unknown if true oversample, but Hispanic, 18+"
   4                = "Not Hispanic, but in family with 1+ Hispanics, 18+"
   5                = "No Hispanics in family, 18+"
   .                = "Not in Hispanic oversample PSU, or under 18 years old"
   ;
  VALUE  PER085X
...
LENGTH
   ...
   HISPOVER  3  PSUTYPE   3  MSA       3  PSUPSEUD  3  CCFACT    8
...
INPUT
   ...
   MSASIZE     183 - 183       HISPOVER    184 - 184
...
LABEL
   ...
   DISDA12X = "NUMBER OF DAYS IN SHORT-STAY HOSPITAL IN PAST 12 MONTHS FOR DISCHARGES IN PAST 6 MONTHS EXCLUDING DELIVE"
   ...
   HISPOVER = "HISPANIC OVERSAMPLE CONTROL RECODE"
   PSUTYPE  = "TYPE OF PSU"
...
FORMAT
   ...
   REGION    PER082X.    MSASIZE   PER083X.    HISPOVER  PER084X.
   PSUTYPE   PER085X.    MSA       PER086X.    PSUPSEUD  PER087X.
...
TITLE1 'FREQUENCY REPORT FOR 1987 NHIS PERSON PUBLIC USE FILE';
TITLE2 '(WEIGHTED)';
