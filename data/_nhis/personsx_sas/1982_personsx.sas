...
FILE FROM THE NHIS 1982 PERSONSX.DAT ASCII FILE.
...
FILENAME ASCIIDAT 'C:\NHIS1982\PERSONSX.DAT';
...
PROC FORMAT LIBRARY=LIBRARY;
  ...
  VALUE  PER045X
   ...
   3                = "Limited in other activities"
   4                = "Not limited (includes unknowns)"
   .                = "Not applicable (under 18 years, 71+ years)"
   ;
  VALUE  PER046X
...
LENGTH
   ...
   PER201    6  PER210    6  PER219    6  PER228    6  PER237    6
...
LABEL
   ...
   PER139   = "NUMBER OF DAYS IN SHORT-STAY HOSPITAL IN PAST '12 MONTHS FOR DISCHARGES IN PAST 6 MONTHS EXCLUDING DELIVERY"
   PER182   = "REGION"
   ...
   PER219   = "FINAL BASIC WEIGHT - ANNUAL (WT/4)"
...
FORMAT
   ...
   PER210    PER085X.    PER219    PER086X.    PER228    PER087X.
...
TITLE1 'FREQUENCY REPORT FOR 1982 NHIS PERSON FILE';
TITLE2 '(WEIGHTED)';
