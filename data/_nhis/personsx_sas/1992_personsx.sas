...
FILE FROM THE NHIS 1992 PERSONSX.DAT ASCII FILE.
...
FILENAME ASCIIDAT 'C:\NHIS1992\PERSONSX.DAT';
...
PROC FORMAT LIBRARY=LIBRARY;
  ...
  VALUE  PER082X
   ...
   5                = "15 years or more"
   9                = "Unknown"
   5    .           = "Not applicable (US born or less than 18 years of age)"
   ;
  VALUE  PER083X
   ...
   3                = "No"
   9                = "Unknown"
   8    .           = "(Under 12 years or 22+ years)"
   ;
  VALUE  PER084X
   1                = "Hispanic nonmover (oversample) (Sample 911-914)"
   2                = "Hispanic nonmover (Sample 921-924)"
   3                = "Hispanic mover    (Sample 921-924)"
   4                = "Nonhispanic Unit  (Sample 921-924)"
   ;
  VALUE  PER085X
   ;
  VALUE  PER086X
...
INPUT
   ...
   YRSLIVPR   144 - 144        YRSLIVUS   145 - 145
...
LABEL
   ...
   MAJACT   = "MAJOR ACTIVITY (18+ YEARS OLD) B-8"
   ...
   SLDAYWP  = "ESTIMATED SCHOOL-LOSS DAYS PAST 2W - QUARTER, SEMI-ANNUAL AND ANNUAL ONTHS"
...
FORMAT
   ...
   BIRTHYR   $PER019X.   HISPFLAG  PER020X.    RACE      PER021X.
   RACER1    PER022X.    RACER2    PER023X.    RACER3    PER024X.
   HISPANIC  PER025X.    MARSTAT   PER026X.    VETERAN   PER027X.
   RESERVE   PER028X.    EDUC      PER029X.    EDUCR     PER030X.
   EDUCAD    PER031X.    EDUCADR   PER032X.    INCFAM20  PER033X.
   INCFAM    PER034X.    INCFAMR   PER035X.    POVERTY   PER036X.
   FAMNUM    $PER037X.   FAMREL    $PER038X.   FAMRELR   PER039X.
   FAMSIZE   PER040X.    FAMSIZER  PER041X.    PARENT    PER042X.
   MAJACT    PER043X.    HEALTH    PER044X.    LATOTAL   PER045X.
   LAWORK    PER046X.    LASCHOOL  PER047X.    LACARE    PER048X.
   EMPLOY    PER049X.    WKCLASS   PER050X.    INDUS     PER051X.
   INDUSR1   PER052X.    INDUSR2   PER053X.    OCCUP     PER054X.
   OCCUPR1   PER055X.    OCCUPR2   PER056X.    RESPOND   PER057X.
   CONDLIST  PER058X.    HEIGHT    PER059X.    WEIGHT    PER060X.
   RADAY     PER061X.    BDDAY     PER062X.    WLDAY     PER063X.
   SLDAY     PER064X.    OTHDAY    PER065X.    BDDAY12   PER066X.
   BDDAY12R  PER067X.    DV12      PER068X.    DVINT     PER069X.
   NCOND     PER070X.    NACUTE    PER071X.    NDV2      PER072X.
   HEP12     PER073X.    HDA12     PER074X.    HEP12X    PER075X.
   HDA12X    PER076X.    DISDA6    PER077X.    DIS6X     PER078X.
   DISDA6X   PER079X.    DISDA12X  PER080X.    YRSLIVPR  PER081X.
   YRSLIVUS  PER082X.    GOSCHOOL  PER083X.    HISPOVER  PER084X.
   ...
   WLDAYWP   PER100X.    SLDAYWP   PER101X.    DV12WPQ   PER102X.
...
TITLE1 'FREQUENCY REPORT FOR 1992 NHIS PERSON FILE';
TITLE2 '(WEIGHTED)';
