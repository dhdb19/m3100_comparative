*********************************************************************
 NOVEMBER 6, 2003 12:57 PM
 
 THIS IS AN EXAMPLE OF A SAS PROGRAM THAT CREATES A SAS
 FILE FROM THE 2002 NHIS PUBLIC USE HOUSEHLD.DAT ASCII FILE
...
LIBNAME  NHIS     'C:\NHIS2002\';
LIBNAME  LIBRARY  'C:\NHIS2002\';

FILENAME ASCIIDAT 'C:\NHIS2002\HOUSEHLD.DAT';
...
PROC CONTENTS DATA=NHIS.HOUSEHLD;
   TITLE1 'CONTENTS OF THE 2002 NHIS HOUSEHLD FILE';

PROC FREQ DATA=NHIS.HOUSEHLD;
   TITLE1 'FREQUENCY REPORT FOR 2002 NHIS HOUSEHLD FILE';
   TITLE2 '(WEIGHTED)';
