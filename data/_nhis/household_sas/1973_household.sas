...
FILE FROM THE NHIS 1973 HOUSEHLD.DAT ASCII FILE.
...
FILENAME ASCIIDAT 'C:\NHIS1973\HOUSEHLD.DAT';
...
LENGTH
   ...
   HH_42     3  HH_43     3  HH_44     3  HH_45     3
...
FORMAT
   ...
   HH_180    $HHD055X.   HH_181    $HHD056X.   WTFQ      HHD057X.
   ;
 
PROC CONTENTS DATA=NHIS.HOUSEHLD;
 
PROC FREQ DATA=NHIS.HOUSEHLD;
TITLE1 'FREQUENCY REPORT FOR 1973 NHIS HOUSEHOLD FILE';
TITLE2 '(WEIGHTED)';
