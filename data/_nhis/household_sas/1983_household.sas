...
FILE FROM THE NHIS 1983 HOUSEHLD.DAT ASCII FILE.
...
FILENAME ASCIIDAT 'C:\NHIS1983\HOUSEHLD.DAT';
...
LABEL
   ...
   HH_28    = "NON-INTERVIEW REASON"
   HH_30    = "MONTH OF COMPLETION"
   HH_32    = "DAY OF COMPLETION"
   ...
   HH_182   = "REGION"
   HH_183   = "TABULATION AREA"
   HH_185   = "TYPE OF PSU"
   HH_186    = "SMSA - NON-SMSA RESIDENCE"
   WTFQ     = "BASIC WEIGHT"
   ;
...
TITLE1 'FREQUENCY REPORT FOR 1983 NHIS HOUSEHOLD FILE';
TITLE2 '(WEIGHTED)';
