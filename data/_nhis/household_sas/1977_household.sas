...
FILE FROM THE NHIS 1977 HOUSEHLD.DAT ASCII FILE.
...
FILENAME ASCIIDAT 'C:\NHIS1977\HOUSEHLD.DAT';
...
FORMAT
   ...
   HH_180    $HHD049X.   HH_181    $HHD050X.   WTFQ      HHD051X.
   ;
 
PROC CONTENTS DATA=NHIS.HOUSEHLD;
 
PROC FREQ DATA=NHIS.HOUSEHLD;
TITLE1 'FREQUENCY REPORT FOR 1977 NHIS HOUSEHOLD FILE';
TITLE2 '(WEIGHTED)';
