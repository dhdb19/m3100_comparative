*********************************************************************
 NOVEMBER 5, 2002  5:03 PM
 
 THIS IS AN EXAMPLE OF A SAS PROGRAM THAT CREATES A SAS
 FILE FROM THE 2001 NHIS PUBLIC USE HOUSEHLD.DAT ASCII FILE
...
LIBNAME  NHIS     'C:\NHIS2001\';
LIBNAME  LIBRARY  'C:\NHIS2001\';

FILENAME ASCIIDAT 'C:\NHIS2001\HOUSEHLD.DAT';
...
PROC CONTENTS DATA=NHIS.HOUSEHLD;
   TITLE1 'CONTENTS OF THE 2001 NHIS HOUSEHLD FILE';

PROC FREQ DATA=NHIS.HOUSEHLD;
   TITLE1 'FREQUENCY REPORT FOR 2001 NHIS HOUSEHLD FILE';
   TITLE2 '(WEIGHTED)';
