...
FILE FROM THE NHIS 1988 HOUSEHLD.DAT ASCII FILE.
...
FILENAME ASCIIDAT 'C:\NHIS1988\HOUSEHLD.DAT';
...
PROC FORMAT LIBRARY=LIBRARY;
  ...
  VALUE  HHD018X
   ...
   01-30            = "Member of persons in family"
   .                = "Non-interview"
   ;
  VALUE  HHD019X
   00               = "Not applicable or only unrelated individuals"
...
INPUT
   ...
   NONIVIEW     28 - 29        DATIVIEW $   30 - 33
   MOIVIEW  $   30 - 31        DAYIVIEW $   32 - 33
...
LABEL
   ...
   DATIVIEW = "DATE OF COMPLETION (OR LAST ATTEMPT) OF INITIAL INTERVIEW"
   MOIVIEW  = "MONTH"
   DAYIVIEW = "DAY"
...
FORMAT
   ...
   NONIVIEW  HHD013X.    DATIVIEW $HHD014X.    MOIVIEW  $HHD015X.
   DAYIVIEW $HHD016X.    NFAM      HHD017X.    SIZEPRIM  HHD018X.
...
TITLE1 'FREQUENCY REPORT FOR 1988 NHIS HOSPITAL PUBLIC USE FILE';
TITLE2 '(WEIGHTED)';
TABLES RECTYPE/LIST MISSING;
WEIGHT WTFA_HH;
 
PROC FREQ DATA=NHIS.HOUSEHLD;
TITLE1 'FREQUENCY REPORT FOR 1988 NHIS HOUSEHOLD PUBLIC USE FILE';
TITLE2 '(UNWEIGHTED)';
TABLES RECTYPE/LIST MISSING;
