*********************************************************************
 ...
 FILE FROM THE NHIS 1998 HOUSEHLD.DAT ASCII FILE
...
LIBNAME NHIS    'C:\NHIS1998\';
LIBNAME LIBRARY 'C:\NHIS1998\';
...
* CREATE A SAS DATA SET STORED IN DIR 'C:\NHIS1998\';
   INFILE 'C:\NHIS1998\HOUSEHLD.DAT' MISSOVER TRUNCOVER LRECL=59;

   * DEFINE LENGTH OF NUMERIC VARIABLES;

   LENGTH
      RECTYPE  3   SRVY_YR  4   INTV_QRT 3   ASSIGNWK 3   LIVQRT   3
      NON_INTV 3   TELENUM  3   INSIDE   3   NOSERV   3   HOWLNGWK 3
      NOWAF_HH 3   ACPT_FAM 3   REJ_FAM  3   ACPT_PER 3   REJ_PER  3
      ACPTCHLD 3   LNG_INTV 3   REGION   3   MSASIZEP 3   WTIA_HH  8
      WTFA_HH  8   STRATUM  4   PSU      3 ;
...
PROC FREQ DATA=NHIS.HOUSEHLD;
   TITLE1 'FREQUENCY REPORT FOR 1998 NHIS HOUSEHLD FILE';
   TITLE2 '(WEIGHTED)';
