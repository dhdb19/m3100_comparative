*********************************************************************
 ...
 file from the 2005 NHIS Public Use househld.DAT ASCII file
 
 This is stored in househld.SAS
*********************************************************************;

* USER NOTE: PLACE NEXT STATEMENT IN SUBSEQUENT PROGRAMS;
LIBNAME  NHIS     "C:\NHIS2005";

* USER NOTE: PLACE NEXT STATEMENT IN SUBSEQUENT PROGRAMS
             IF YOU ALLOW PROGRAM TO PERMANENTLY STORE FORMATS;
LIBNAME  LIBRARY  "C:\NHIS2005";

FILENAME ASCIIDAT 'C:\NHIS2005\househld.dat';
...
PROC CONTENTS DATA=NHIS.househld;
   TITLE1 'CONTENTS OF THE 2005 NHIS Household FILE';

PROC FREQ DATA=NHIS.househld NOTITLE;
   TABLES RECTYPE/LIST MISSING;
   TITLE1 'FREQUENCY REPORT FOR 2005 NHIS Household FILE';
   TITLE2 '(WEIGHTED)';
   WEIGHT WTFA_HH;
