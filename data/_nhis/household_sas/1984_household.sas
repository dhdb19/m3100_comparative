...
FILE FROM THE NHIS 1984 HOUSEHLD.DAT ASCII FILE.
...
FILENAME ASCIIDAT 'C:\NHIS1984\HOUSEHLD.DAT';
...
PROC FORMAT LIBRARY=LIBRARY;
  ...
  VALUE  HHD044X
   ...
   64               = "Portland, Oregon"
   .                = "Nonself-representing Sections and self-representing SMSA's other than those recoded 34-64"
   ;
  VALUE  HHD045X
...
LABEL
   ...
   HH_30    = "MONTH OF COMPLETION (OR LAST ATTEMPT)"
   HH_32    = "DAY OF COMPLETION (OR LAST ATTEMPT)"
...
TITLE1 'FREQUENCY REPORT FOR 1984 NHIS HOUSEHOLD PUBLIC USE FILE';
TITLE2 '(WEIGHTED)';
