*********************************************************************
 ...
 FILE FROM THE NHIS 1997 HOUSEHLD.DAT ASCII FILE
 
 THIS IS STORED IN HOUSEHLD.SAS
*********************************************************************;
* PLACE NEXT TWO STATEMENTS IN SUBSEQUENT PROGRAMS;

LIBNAME NHIS    'C:\NHIS1997\';
LIBNAME LIBRARY 'C:\NHIS1997\';
...
DATA NHIS.HOUSEHLD;
   INFILE 'C:\NHIS1997\HOUSEHLD.DAT' MISSOVER TRUNCOVER LRECL=61;

   * DEFINE LENGTH OF NUMERIC VARIABLES;

   LENGTH
      RECTYPE  3   SRVY_YR  4   INTV_QRT 3   ASSIGNWK 3   INT_M_P  3
      INT_Y_P  4   LIVQRT   3   NON_INTV 3   TELENUM  3   INSIDE   3
      NOSERV   3   HOWLNGWK 3   NOWAF_HH 3   ACPT_FAM 3   REJ_FAM  3
      NO_FAM   3   ACPT_PER 3   REJ_PER  3   ACPTCHLD 3   LNG_INTV 3
      REGION   3   MSASIZEP 3   WTIA_HH  8   WTFA_HH  8   STRATUM  4
      PSU      3 ;
   ...
   * INPUT ALL VARIABLES;
   ...
   INPUT
      ...
      NO_FAM       35 -  36    ACPT_PER     37 -  38
      REJ_PER      39 -  40    ACPTCHLD     41 -  42
      LNG_INTV     43 -  43    REGION       44 -  44
      MSASIZEP     45 -  45    WTIA_HH      46 -  51 .1
      WTFA_HH      52 -  57    STRATUM      58 -  60
      PSU          61 -  61;
   ...
   * DEFINE VARIABLE LABELS;
   ...
   LABEL
      ...
      NOSERV   ="Telephone service in past 12 months"
      ...
      NO_FAM   ="Person(s) not assigned to any family"
   ...
   * ASSOCIATE VARIABLES WITH FORMAT VALUES;
   ...
   FORMAT
      ...
      ACPT_FAM HHP015X.    REJ_FAM  HHP016X.    NO_FAM   HHP016X.
      ACPT_PER HHP015X.    REJ_PER  HHP016X.    ACPTCHLD HHP016X.
      LNG_INTV HHP021X.    REGION   HHP022X.    MSASIZEP HHP023X.;

PROC CONTENTS DATA=NHIS.HOUSEHLD;

PROC FREQ DATA=NHIS.HOUSEHLD;
   TITLE1 'FREQUENCY REPORT FOR 1997 NHIS HOUSEHLD FILE';
   TITLE2 '(WEIGHTED)';
