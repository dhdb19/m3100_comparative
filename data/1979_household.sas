...
FILE FROM THE NHIS 1979 HOUSEHLD.DAT ASCII FILE.
...
FILENAME ASCIIDAT 'C:\NHIS1979\HOUSEHLD.DAT';
...
LENGTH
   WEEKCEN   3  RECTYPE   3  QUARTER   3  YEAR      3  HH_28     3
   HH_29     3  HH_30     3  HH_33     3  HH_36     3  HH_37     3
   HH_50     3  HH_51     3  HH_52     3  HH_56     3  HH_58     3
...
INPUT
   ...
   HH_98    $  98 - 99         HH_108     108 - 108
   HH_180   $ 180 - 180        WTFQ       188 - 193 .1
   ;
   WTFA_HH=WTFQ/4;
...
FORMAT
   ...
   YEAR      HHD007X.    HH_28     HHD008X.    HH_29     HHD009X.
   HH_30     HHD010X.    HH_33     HHD011X.    HH_36     HHD012X.
   HH_37     HHD013X.    HH_43     $HHD014X.   HH_50     HHD015X.
   HH_51     HHD016X.    HH_52     HHD017X.    HH_56     HHD018X.
   HH_58     HHD019X.    HH_66     HHD020X.    HH_68     HHD021X.
   HH_70     HHD022X.    HH_72     HHD023X.    HH_74     HHD024X.
   HH_76     HHD025X.    HH_78     HHD026X.    HH_80     HHD027X.
   HH_82     HHD028X.    HH_84     HHD029X.    HH_86     HHD030X.
   HH_87     HHD031X.    HH_88     HHD032X.    HH_89     HHD033X.
   HH_90     HHD034X.    HH_91     HHD035X.    HH_92     HHD036X.
   HH_93     HHD037X.    HH_94     HHD038X.    HH_95     HHD039X.
   HH_96     $HHD040X.   HH_98     $HHD041X.   HH_108    HHD042X.
   HH_180    $HHD043X.   WTFQ      HHD044X.
   ;
 
PROC CONTENTS DATA=NHIS.HOUSEHLD;
 
PROC FREQ DATA=NHIS.HOUSEHLD;
TITLE1 'FREQUENCY REPORT FOR 1979 NHIS HOUSEHOLD FILE';
TITLE2 '(WEIGHTED)';
