*********************************************************************
 ...
 file from the 2006 NHIS Public Use househld.DAT ASCII file
...
FILENAME ASCIIDAT 'C:\NHIS2006\househld.dat';
...
PROC CONTENTS DATA=NHIS.househld;
   TITLE1 'CONTENTS OF THE 2006 NHIS Household FILE';

PROC FREQ DATA=NHIS.househld NOTITLE;
   TABLES RECTYPE/LIST MISSING;
   TITLE1 'FREQUENCY REPORT FOR 2006 NHIS Household FILE';
   TITLE2 '(WEIGHTED)';
   WEIGHT WTFA_HH;
