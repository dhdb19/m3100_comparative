...
FILE FROM THE NHIS 1985 HOUSEHLD.DAT ASCII FILE.
...
FILENAME ASCIIDAT 'C:\NHIS1985\HOUSEHLD.DAT';
...
TITLE1 'FREQUENCY REPORT FOR 1985 NHIS HOUSEHOLD PUBLIC USE FILE';
TITLE2 '(WEIGHTED)';
